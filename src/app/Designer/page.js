        ...
        <div>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    { products.length==0 && <div className='my-4 font-semibold '>We are adding Designer jewellery soon.</div>}
...
const getdata = async () => {
    ...
    let products = await Product.find({ category: 'Designer jewellery' });
...
export default dynamic(() => Promise.resolve(Designer), { ssr: false })